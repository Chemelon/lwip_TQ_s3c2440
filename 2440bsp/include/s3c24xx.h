...
#define MEM_CTL ((memory_controller_type *)(MEM_CTL_BASE))
...
#define ADCTSC                                                                 \
  (*(volatile unsigned long *)0x58000004) // ADC touch screen control
#define ADCDLY                                                                 \
  (*(volatile unsigned long *)0x58000008) // ADC start or Interval Delay
...
#define ADCUPDN                                                                \
  (*(volatile unsigned long *)0x58000014) // Stylus Up/Down interrupt status
...
#define LCDSADDR1                                                              \
  (*(volatile unsigned long *)0x4d000014) // STN/TFT Frame buffer start address
                                          // 1
#define LCDSADDR2                                                              \
  (*(volatile unsigned long *)0x4d000018) // STN/TFT Frame buffer start address
                                          // 2
#define LCDSADDR3                                                              \
  (*(volatile unsigned long *)0x4d00001c) // STN/TFT Virtual screen address set
#define REDLUT (*(volatile unsigned long *)0x4d000020) // STN Red lookup table
#define GREENLUT                                                               \
  (*(volatile unsigned long *)0x4d000024) // STN Green lookup table
...
#define LCDINTPND                                                              \
  (*(volatile unsigned long *)0x4d000054) // LCD Interrupt pending
#define LCDSRCPND (*(volatile unsigned long *)0x4d000058) // LCD Interrupt
                                                          // source
